<main role="main" class="m-auto px-5 main">
  ...
  if(empty($grades))
    ...
    echo "Class: " .  $grades[0]->{'class'};} ?><br>Statistics By Subjects</h1>
    </div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
   
   <div class="input-group-prepend d-block col-12 pl-0 pr-0 ml-3">
       <a href="Headmaster/classes" class="btn-back float-left" role="button">Back</a>
   </div>
 </div>
