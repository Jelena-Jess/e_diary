...
<head>
    ...
    <link rel="stylesheet" href="public/css/dycalendar.css">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
    <ul class="navbar-nav mr-auto d-flex bd-highlight mb-7">
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Admin/dashboard_admin">Home
        </a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Admin/users_admin">Users</a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Admin/subjects_admin">Subjects</a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Admin/teachers_admin">Teachers</a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Admin/classes_admin">Students</a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Admin/timetable_admin">Timetable</a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Admin/noticeboard_admin">Noticeboard</a>
      </li>
    </ul>
    <ul class="navbar-nav ml-auto nav-flex-icons">
      ...
      <li class="nav-item nav-item-personal dropdown bd-highlight nav">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-default"
          ...
          <a class="dropdown-item" href="Admin/personal">Profile</a>
