  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
    <ul class="navbar-nav mr-auto d-flex bd-highlight mb-7">
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Headmaster/dashboard">Home
          <span class="sr-only">(current)</span>
        </a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Headmaster/classes">Statistics By Classes</a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Headmaster/school_statistics">School Statistics</a>
      </li>
    </ul>
    <ul class="navbar-nav ml-auto nav-flex-icons">
      ...
      <li class="nav-item nav-item-personal dropdown bd-highlight nav">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-default"
          ...
          <a class="dropdown-item" href="Headmaster/personal">Profile</a>
