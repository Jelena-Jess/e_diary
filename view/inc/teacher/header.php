  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
    <ul class="navbar-nav mr-auto d-flex bd-highlight mb-7">
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Teacher/teachers_dashboard">Home
        </a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Teacher/teachers_class">Grades</a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Teacher/teachers_timetable">Timetable</a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Teacher/messages">Messages</a>
      </li>
      <li class="px-2 nav-item bd-highlight nav">
        <a class="nav-link" href="Teacher/teachers_opendoor">Opendoor</a>
      </li>
    </ul>
    ...
    <li class="nav-item nav-item-personal dropdown bd-highlight nav">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-default"
          ...
          <a class="dropdown-item" href="Teacher/personal">Profile</a>
